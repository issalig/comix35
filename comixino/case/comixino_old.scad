...
module conn_side_hole(depth=5){
    ...
    translate([5.0, 68,int_support_height+pcb_deep+11.5])
    #cube([13.5-5,thick_hor*2,16.2-11.5]);
    
    //jumpers
    translate([19.53,68,depth])
    #cube([69.9-19.53,thick_hor*2,7]);
    
    //sd 
    translate([60.91, 68,int_support_height+pcb_deep+11.5])
    #cube([18, thick_hor*2, 16.2-11.5]);
...
%translate([-75.6,124.3,int_support_height+pcb_deep/2])
import("comixino.stl");
...
#difference(){
    ...
    #translate([57.91, 24.64,int_support_height+pcb_deep+11.5])
    sd();
    #translate([0.11, 22.80,int_support_height+pcb_deep+11.5])
    arduino(); 
...
module top(depth=12.5){
    ...
    translate([width*0.45,height*0.85,+depth+1*depth_dent+thick_vert-0.5])        
    #logo();
